 ...
 */
public class ReturnMessage4UploadPhoto implements Serializable {
	...
	public ReturnMessage4UploadPhoto(String message, boolean result) {
		this.message = message;
		this.result = result;
	}

	public ReturnMessage4UploadPhoto() {
		// 默认构造器
	}
