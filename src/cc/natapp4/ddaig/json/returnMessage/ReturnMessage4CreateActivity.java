 ...
 */
public class ReturnMessage4CreateActivity implements Serializable {

	private String message;
	private boolean result;

	private DoingProject  dp;
	...
	public DoingProject getDp() {
		return dp;
	}

	public void setDp(DoingProject dp) {
		this.dp = dp;
	}

	public ReturnMessage4CreateActivity() {
		// 默认构造器
	}
