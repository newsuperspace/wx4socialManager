 ...
 */
public class ReturnMessage4ShowUpdateModal4Geo implements Serializable {
	...
	public ReturnMessage4ShowUpdateModal4Geo(String message, boolean result) {
		this.message = message;
		this.result = result;
	}

	public ReturnMessage4ShowUpdateModal4Geo() {
		// 默认构造器
	}
