...
<body style="background-color: #f8f8f8;">
	...
	<div>
		...
		<div style="padding: 30px;">
			<h1
				style="text-align: left;font-size: 20px;font-weight: 400;font-weight: bold;">您当前加入的社团</h1>
			<p
				style="margin-top: 5px;color: #888;text-align: left;font-size: 14px;">在这里您可以查看自己当前加入的社团</p>
		</div>
