...
var __parent0=require('$model/UI2/weixin/createActivity'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='cFJfEni';
	this._flag_='ef6d9c16f8e7f56d0b0ae096e184db5a';
	this.callParent(contextUrl);
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"description":{"define":"description","label":"活动描述：","name":"description","relation":"description","type":"String"},"name":{"define":"name","label":"活动名称：","name":"name","relation":"name","type":"String"},"score":{"define":"score","label":"活动积分：","name":"score","relation":"score","rules":{"integer":true},"type":"Long"}},"directDelete":false,"events":{},"idColumn":"name","initData":"[{}]","limit":20,"xid":"regData"});
}}); 
return __result;});
