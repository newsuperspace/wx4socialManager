...
var __parent0=require('$model/UI2/weixin/dialog4Signin'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='cmi2IRv';
	this._flag_='2b9e61fe4a0e24903fa0e9b61b30300f';
	this.callParent(contextUrl);
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"qrcode":{"define":"qrcode","label":"二维码","name":"qrcode","relation":"qrcode","type":"String"}},"directDelete":false,"events":{},"idColumn":"qrcode","limit":20,"xid":"data"});
}}); 
return __result;});
