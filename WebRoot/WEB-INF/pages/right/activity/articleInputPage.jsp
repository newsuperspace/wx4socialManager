			...
			<div class="col-xs-12 col-md-10 col-lg-10">
				...
				<div class="row">
					<div class="col">
								...
								<div class="btn-group mr-2">
									...
									<div class="dropdown ml-1">
										...
										<div class="dropdown-menu dropdown-menu-right"
											...
											<a class="dropdown-item disabled" href="#">功能2
												action</a>
						...
						<!-- =============文章编辑开始=========== -->
						<input type="hidden"  name="artid" value="<s:property value='artid'/>"/>
						<input type="hidden"  name="aid" value="<s:property value='activity.aid'./>"/>
						
						<div class="weui-cells__title">文章标题</div>
						<div class="weui-cells">
							<div class="weui-cell">
								<div class="weui-cell__bd">
									<input class="weui-input" type="text" placeholder="请输入30字以内文本"  name="title" value="<s:property value='%{title}'/>"/>
								</div>
							</div>
						</div>
						...
						<div class="weui-cells">
							<div class="weui-cell">
								<div class="weui-cell__bd">
									<input class="weui-input" disabled="disabled"  type="text" placeholder="请输入文本"  value="<s:property value='%{activity.endTimeStr}'/>"/>
								</div>
							</div>
						</div>
						...
						<div class="weui-cells weui-cells_form">
							<div class="weui-cell">
								<div class="weui-cell__bd">
									<textarea class="weui-textarea" placeholder="请输入文本" rows="5"  name="content" value="<s:property value='%{content}'/>"
										oninput="getNumbers(this);"></textarea>
									...
									<div class="weui-uploader">
										<div class="weui-uploader__hd">
											...
											<div class="weui-uploader__info">
												<span id="uploadCount"><s:property value="photos.size()" /></span>/5
											</div>
										</div>
										<div class="weui-uploader__bd">
											<ul class="weui-uploader__files" id="uploaderFiles">
												...
												<s:iterator value="photos">
													<li class="weui-uploader__file" style="background-image:url(<s:property value='%{url}' />)" id="<s:property value='%{apid}' />"></li>					
												</s:iterator>
												<!-- 触发上传的+号按钮 -->
						...
						<!-- =============文章编辑结束=========== -->
						<button type="button" name="save" id="save"   onclick="save();"  class="btn btn-primary" btn-lg btn-block">保存</button>
	...
	$(function () {
      ...
      weui.uploader('#uploader', {
        ...
        onQueued: function () {
          ...
          var dom =
            '<li class="weui-uploader__file weui-uploader__file_status" style="background-image:url('+this.url+')" id="' +
