							...
							<div class="btn-toolbar mb-2 mb-md-0">
								...
								<div class="btn-group mr-4">
									<button disabled class="btn btn-sm btn-outline-secondary">
										<span class="glyphicon glyphicon-plus"></span> 保存设置
									</button>
									<button id="cancel" class="btn btn-sm btn-outline-secondary"
										onclick="setRadioSelected('no');">
										<span class="glyphicon glyphicon-minus"></span> 取消设置
									</button>
									<a name="aaa" id="aaa" class="btn btn-sm btn-outline-secondary"
										href="#" role="button" onclick="getRadioValue();"> <span
										class="glyphicon glyphicon-time"></span> 初始化设置
									</a>
								</div>
								<!--popup-->
								<div class="dropdown">
							...
							<div class="row mb-3">
								...
								<div class="col-md-auto mr-4">
									...
									<div class="form-check">
										<input class="form-check-input" type="radio" name="joinApply"
											id="joinApply1" value="yes"> <label
											class="form-check-label" for="joinApply1"> 需要 </label>
									</div>
								</div>
								<div class="col-md-auto">
									...
									<div class="form-check">
										<input class="form-check-input" type="radio" name="joinApply"
											id="joinApply2" value="no"> <label
											class="form-check-label" for="joinApply2"> 不需要 </label>
									</div>
								</div>
							</div>
						</div>
...
<script>
	...
	var vr = "yes";
	$(function() {
		console.log("各项设置项的初始化工作开始");

		// 初始化：“申请设置”→“申请加入时是否需要提交申请”
		setRadioSelected(vr);
	// 初始化2：
	// 初始化3：
	// ....
	...
	function getRadioValue() {
		...
		//     alert($(this).val());
		// }
		let v = $("input[name='joinApply']:checked").val();
		alert("选中的radio的值是：" + v);
		if ('yes' == v) {
