							...
							<table
								...
								<tbody>
									<s:iterator value="#houses">
										<tr>
											<td><s:a href="#"
													onclick="houseModal.op.houseInfo('%{hid}')">
													<!-- ● -->
												...
												<myShiro:hasAnyPermissions name="admin,zero:house:updateHouse">
													<div class="btn-group" role="group">
														...
														<s:a cssClass="btn btn-sm btn-outline-secondary"
															role="button"
															onclick="houseModal.op.showUpdateModal('%{hid}');"
															href="#">修改</s:a>

														<s:if test="enable">
															<s:a cssClass="btn btn-sm btn-outline-secondary"
																role="button"
																onclick="houseModal.op.closeHouse('%{hid}');" href="#">关闭</s:a>
														</s:if>
														<s:else>
															<s:a cssClass="btn btn-sm btn-outline-secondary"
																role="button"
																onclick="houseModal.op.openHouse('%{hid}');" href="#">启用</s:a>
														</s:else>
