					...
					<div class="col">
                        ...
                        overflow-x: auto;">
							<table
								...
								<tbody>
									<!-- ● -->
									<s:iterator value="#permissionTypes">
										<tr>
											<td><s:property
													value="permissionLevel.permissionLevelName" /></td>
											<td><s:a href="#"
													onclick="permissionTypeModal.op.itemInfo('%{ptid}')">
													<s:property value="permissionTypeName" />
												</s:a></td>
											<td class="text-truncate" data-toggle="tooltip"
												title=<s:property value="ptid" />><s:property
													value="ptid" /></td>
				...
				<div class="modal-content">
						...
						<div class="container-fluid">
							...
							<div class="input-group input-group-sm mb-3">
								...
								<input type="text" class="form-control"
									name="permissionTypeName" id="permissionTypeName">
								<div class="input-group-prepend">
									<span class="input-group-text">权限类型名称</span>
								</div>
								<!-- ● -->
							</div>
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary"
							onclick="permissionTypeModal.op.create();">新建</button>
					</div>
				</div>
			</div>
		</div>
